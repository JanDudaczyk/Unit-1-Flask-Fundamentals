...
@app.route("/temp_convert/<int:temp1>/<conversion_factor>/<temp_final>")
def temp_converter(temp1, conversion_factor, temp_final):
    conversion_factor = {temp1} * 5/9 - 32
    temp_final = conversion_factor
    return f"{temp1} when converted is {temp_final}"
